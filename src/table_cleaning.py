...
def main():
    try:
        ...
        new_data = get_karat_db.get_table_from_kdl("Продажи_ПродажиФакт", start_date, end_date)
        ...
        main_dataframe = get_karat_db.get_table_from_kdl(
            "Продажи_ПродажиФакт",
            "01.08.2024",
...
def merging(main_dataframe: pd.DataFrame):
    sales_contragents = get_karat_db.get_table_from_kdl("Продажи_НСИ_Контрагенты")
    ...
    sales_clients = get_karat_db.get_table_from_kdl("Продажи_НСИ_Клиенты")
